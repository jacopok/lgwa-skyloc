"""This script generates figure "Figures/multiband_horizon_et_lgwa.pdf"
and "Figures/multiband_horizon_lisa_lgwa.pdf" in the LGWA whitepaper.
"""

from gw_landscape.gwfish import GWFishDetector
from gw_landscape.plot import make_redshift_distance_axes
from gw_landscape.waterfall import plot_snr_area, compute_horizon_from_masses, ET_COLOR, LGWA_COLOR, LISA_COLOR
import numpy as np
